<template>
  <div class="buy-client">
          ...
          <div class="dialog-box">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
              ...
              <el-form-item label="购买价格（万元）" prop="sale_price" class="price-form">
                <el-input v-model="ruleForm.sale_price" placeholder="请输入购买价格"></el-input>
              </el-form-item>
    ...
    <el-table :data="tableData" ref="multipleTable" border :row-style="tableRowStyle"
      ...
      <el-table-column prop="label" label="类型" min-width="18%" align="center">
      ...
      <el-table-column prop="shape" label="购买车型" min-width="20%" align="center"></el-table-column>
      <el-table-column prop="sale_price" label="购买价格（万元）" min-width="20%" align="center"></el-table-column>
    ...
    <el-dialog title="修改信息" :visible.sync="dialogUpdate" width="50%">
      <el-form :model="updateForm" :rules="rulesUpdate" ref="updateForm">
        ...
        <el-form-item label="购买价格（万元）" prop="sale_price" class="price-form">
          <el-input v-model="updateForm.sale_price" placeholder="请输入购买价格"></el-input>
        </el-form-item>
      </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      update: function (row) {
        ...
        this.updateForm.sale_price = row.sale_price;
      ...
      updateConfirm: function (updateForm) {
        const form = {
          ...
          sale_price: this.updateForm.sale_price,
