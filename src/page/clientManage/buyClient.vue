<template>
  <div class="buy-client">
    ...
    <el-table :data="tableData" ref="multipleTable" border :row-style="tableRowStyle"
      ...
      <el-table-column prop="phone" label="电话" min-width="18%" align="center"></el-table-column>
      ...
      <el-table-column prop="shape" label="购买车型" min-width="15%" align="center"></el-table-column>
      <el-table-column prop="sale_price" label="购买价格（万元）" min-width="18%" align="center"></el-table-column>
